...
class MinecraftDrawing:
    ...
    :param mpi.minecraft.Minecraft mc:
    ...
    def drawFace(self, vertices, filled, blockType, blockData=0):
        ...
        :param list vertices:
            ...
            or as a list of ``mpi.minecraft.Vec3`` objects.
    ...
    def drawVertices(self, vertices, blockType, blockData=0):
        ...
        :param list vertices:
            A list of ``mpi.minecraft.Vec3`` objects.
...
class MinecraftShape:
    ...
    :param mpi.minecraft.Vec3 position:
...
class MinecraftTurtle:
    ...
    def __init__(self, mc, position=minecraft.Vec3(0, 0, 0), port=4711,
                 offset_front=(1, 0), offset_left=(0, -1), offset_right=(0, 1)):
        # set defaults
        self.mc = mc
        # start position
    ...
    def backward(self, distance):
        ...
        # x, y, z = self._findPointOnSphere(self.position.x, self.position.y, self.position.z, self.heading,
        #                                   self.verticalheading - 180, distance)
        # move turtle forward
        self._moveTurtle(x, y, z)
